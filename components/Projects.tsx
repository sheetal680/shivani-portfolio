...
function ProjectCard({ project, index, prefersReduced }: { project: Project; index: number; prefersReduced: boolean | null }) {
  ...
  const handleMouseLeave = () => {
    ...
    cardRef.current.style.transition = "transform 0.5s ease, background 0.5s ease";
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col">
          ...
          >
            ...
            <span className="inline-block group-hover/link:translate-x-1 transition-transform duration-200" aria-hidden="true">→</span>
          </a>
        </div>
      </div>
    </motion.article>
