...
export default function Experience() {
  ...
  return (
    <section id="experience" aria-labelledby="experience-heading" className="py-16 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <motion.article
            ...
            className="p-4 sm:p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300"
          >
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <div className="relative w-7 h-7 sm:w-8 sm:h-8 rounded-lg overflow-hidden shrink-0 bg-black border border-white/10">
                    <Image
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-white leading-tight">Co-Founder &amp; CEO</h3>
                    <p className="text-purple-400 font-semibold text-sm">Voxinta</p>
                  </div>
                </div>
              </div>
              <time className="text-xs sm:text-sm text-gray-500 font-medium shrink-0">2024 – Present</time>
            </div>
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
              ...
              <time className="text-xs sm:text-sm text-gray-500 font-medium shrink-0">{education.graduation}</time>
            </div>
            <ul className="space-y-3">
